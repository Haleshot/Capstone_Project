...
Welcome to `Capstone_project` contributor's guide.
...
If you experience bugs or general issues with `Capstone_project`, please have a look
...
You can help improve `Capstone_project` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`Capstone_project` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `Capstone_project`'s files. While this mechanism can
...
```
conda create -n Capstone_project python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/Capstone_project.git
   cd Capstone_project
   ```
...
5. Install [pre-commit]:
   ...
   `Capstone_project` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/Capstone_project
[issue tracker]: https://github.com/<USERNAME>/Capstone_project/issues
